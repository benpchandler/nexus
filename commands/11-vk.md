...
- `.jim/current/_10-REQUIREMENTS.md` - The requirements document to validate
- `.jim/!CONFIG.json` - System configuration
...
Also create/update:
1. `.jim/artifacts/10-requirements/15-VALIDATION-<timestamp>.md` - This report
2. `.jim/current/_40-ISSUES.md` - Add critical findings
3. `.jim/artifacts/10-requirements/versions/15-VALIDATION-LOG.md` - Track validations
</output_structure>
